...
INTEGRAL_PATH = Path("./src/fog_pipeline/simulate_fog/lidar/LiDAR_fog_sim/integral_lookup_tables")
...
def get_integral_dict(p: ParameterSet) -> Dict:
    ...
    filename = INTEGRAL_PATH / f'integral_0m_to_200m_stepsize_0.1m_tau_h_{tau_h}ns_alpha_{alpha:.3f}.pickle'
