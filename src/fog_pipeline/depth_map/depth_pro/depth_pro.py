...
DEFAULT_MONODEPTH_CONFIG_DICT = DepthProConfig(
    ...
    checkpoint_uri="./src/fog_pipeline/depth_map/depth_pro/checkpoints/depth_pro.pt",
...
def create_model_and_transforms(
    ...
    if config.checkpoint_uri is not None:
        state_dict = torch.load(config.checkpoint_uri, map_location="cpu", weights_only=False)
