...
load_from = '/users/sgmmoha5/scratch/mmdetection_checkpoints/fixed/fixed_100_seed3/best_coco_bbox_mAP_epoch_10.pth'

work_dir = '/users/sgmmoha5/scratch/mmdetection_checkpoints/stf/fixed_then_stf/100_seed3_lr0.0002'
