...
data_root_train = '/mnt/scratch/users/sgmmoha5/waymo_extracted/'
data_root_holdout = '/mnt/scratch/users/sgmmoha5/waymo_extracted/'
...
train_dataset = dict(
    dataset=dict(
        ...
        ann_file='training/annotations_50.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='hold_out/images/')))
...
work_dir = '/mnt/scratch/users/sgmmoha5/mmdetection_checkpoints/clear/yolox_clear_50_seed3'
