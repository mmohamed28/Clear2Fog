...
data_root_train = '/users/sgmmoha5/scratch/KITTI/training/c2f_foggy_images_mixed/split/'
data_root_holdout = '/users/sgmmoha5/scratch/KITTI/training/c2f_foggy_images_mixed/split/'
...
work_dir = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/foggy_c2f_mixed_seed2'
