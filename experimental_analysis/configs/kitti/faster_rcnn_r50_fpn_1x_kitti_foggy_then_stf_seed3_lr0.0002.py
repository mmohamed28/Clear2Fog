...
load_from = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/foggy_seed3/best_coco_bbox_mAP_epoch_10.pth'

work_dir = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/foggy_then_stf_seed3_lr0.0002'
