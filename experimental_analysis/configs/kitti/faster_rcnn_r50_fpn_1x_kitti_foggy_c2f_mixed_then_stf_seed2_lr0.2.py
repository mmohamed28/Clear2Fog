...
load_from = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/foggy_c2f_mixed_seed2/best_coco_bbox_mAP_epoch_9.pth'

work_dir = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/foggy_c2f_mixed_then_stf_seed2_lr0.2'
