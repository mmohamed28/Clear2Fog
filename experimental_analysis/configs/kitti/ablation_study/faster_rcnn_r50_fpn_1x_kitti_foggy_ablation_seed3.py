...
data_root_train = '/users/sgmmoha5/scratch/KITTI/atmospheric_ablation/split/'
data_root_holdout = '/users/sgmmoha5/scratch/KITTI/atmospheric_ablation/split/'
...
work_dir = '/users/sgmmoha5/scratch/mmdetection_checkpoints/kitti/ablation_seed3'
