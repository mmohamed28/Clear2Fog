...
data_root_train = '/users/sgmmoha5/scratch/waymo_foggy_fixed/'
data_root_holdout = '/users/sgmmoha5/scratch/waymo_foggy_fixed/'
...
work_dir = '/mnt/scratch/users/sgmmoha5/mmdetection_checkpoints/fixed/yolox_fixed_50_seed2'
